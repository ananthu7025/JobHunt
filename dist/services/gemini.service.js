...
class GeminiService {
    ...
    async analyzeResume(resumeText, jobDescription, additionalRequirements, weightage = { skills: 30, experience: 25, education: 20, keywords: 25 }) {
        try {
            const prompt = this.createAnalysisPrompt(resumeText, jobDescription, additionalRequirements, weightage);
    ...
    createAnalysisPrompt(resumeText, jobDescription, additionalRequirements, weightage) {
        return `
